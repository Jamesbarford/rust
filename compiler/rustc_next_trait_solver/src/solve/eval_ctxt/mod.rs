    ...
    I: Interner,
{
    ...
    pub(super) fn next_ty_infer(&mut self) -> ty::Ty<I> {
    ...
    pub(super) fn shallow_resolve(&self, ty: ty::Ty<I>) -> ty::Ty<I> {
    ...
    pub(super) fn register_ty_outlives(&self, ty: ty::Ty<I>, lt: I::Region) {
