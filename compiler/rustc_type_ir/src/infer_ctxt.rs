...
pub trait InferCtxtLike: Sized {
    ...
    fn opportunistic_resolve_ty_var(&self, vid: ty::TyVid) -> ty::Ty<Self::Interner>;
    fn opportunistic_resolve_int_var(&self, vid: ty::IntVid) -> ty::Ty<Self::Interner>;
    fn opportunistic_resolve_float_var(&self, vid: ty::FloatVid) -> ty::Ty<Self::Interner>;
    ...
    fn next_ty_infer(&self) -> ty::Ty<Self::Interner>;
    ...
    fn shallow_resolve(&self, ty: ty::Ty<Self::Interner>) -> ty::Ty<Self::Interner>;
    ...
    fn clone_opaque_types_lookup_table(
        &self,
    ) -> Vec<(ty::OpaqueTypeKey<Self::Interner>, ty::Ty<Self::Interner>)>;
    ...
    fn register_hidden_type_in_storage(
        ...
        hidden_ty: ty::Ty<Self::Interner>,
        span: <Self::Interner as Interner>::Span,
    ) -> Option<ty::Ty<Self::Interner>>;
